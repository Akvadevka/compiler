...
//                throw new ParseException("Unexpected token: " + getCurrentToken().code);
    ...
    private VariableDeclarationNode parseDeclaration() {
        ...
        if (getCurrentToken().code == TokenCode.ASSIGN) {
            ...
            IdentifierNode variable = new IdentifierNode(variableName.identifier);
            return new VariableDeclarationNode(variable, initializer, null);
        } else {
            IdentifierNode variable = new IdentifierNode(variableName.identifier);
            return new VariableDeclarationNode(variable, null, null);
        }
    }
...
//            String functionName = functionToken.identifier;
    ...
    private VariableDeclarationNode parseParameter() {
        ...
        IdentifierNode paramNameIden = new IdentifierNode(paramName);
        return new VariableDeclarationNode(paramNameIden, defaultValue, null);
    }
